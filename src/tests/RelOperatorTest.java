...
class RelOperatorTest extends TestDriver {
   ...
   */
	...
	// /**
	// * SELECT * FROM Drivers D INNER JOIN Rides R ON (D.DriverId =
	// R.DriverId);
	// */
	...
	// INNER
	// * JOIN Drivers D ON (R.DriverId = D.DriverId) WHERE D.NumSeats <
	// G.GroupId;
	// */
	...
	// HashJoin join2 = new HashJoin(join1, new FileScan(s_drivers, drivers), 2,
	// 0);
